    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-20">
      ...
      <div className="flex-grow flex flex-col justify-center items-center text-center px-6 relative z-10">
        <FadeIn delay={100} className="flex flex-col items-center max-w-5xl">
          ...
          <h1 className="sr-only">Cahyo Dev — Portfolio | Web & Mobile Developer Yogyakarta</h1>

          {/* Main Visual Headline */}
          <h2 className="font-display font-bold text-6xl md:text-8xl lg:text-9xl tracking-tighter text-white mb-8 leading-[0.9] drop-shadow-2xl">
            Designing <br />
