          ...
          <div className="space-y-2">
            <FadeIn delay={100}>
              <CVItem
                ...
                org="Sayur Sleman"
                desc="Magang. Focused on social media strategy and content management in Yogyakarta."
              />
            </FadeIn>
            <FadeIn delay={200}>
              <CVItem
                ...
                org="Tandang Studio"
                desc="Paruh Waktu. Working on web development and search engine optimization strategies."
              />
            </FadeIn>
            <FadeIn delay={300}>
              <CVItem
